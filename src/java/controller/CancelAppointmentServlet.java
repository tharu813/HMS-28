...
public class CancelAppointmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            db.deleteAppointment(Integer.parseInt(app_id));

            RequestHandler.retrieveAttribute(request, "appointments");
            ArrayList<String[]> appointments = db.getAppointments(RequestHandler.getCurrentUser(request).getUserId());
