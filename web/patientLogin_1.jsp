            ...
            <div class="workinghny-block-grid">
                <div class="form-right-inf">
                    ...
                    <div class="login-form-content">
                        ...
                        <form action="<%=request.getContextPath()%>/patientLoginServlet" class="signin-form" method="post">
                            <div class="one-frm">
                                <input type="text" name="user_id" placeholder="username" required="" autofocus>
                            </div>
                            <div class="one-frm">
