  ...
  <div class="container-agille">
    <div class="formBox level-login">
      ...
      <div class="box loginBox">
        <h3>Enter Doctor name</h3>
        <form class="form" action="<%=request.getContextPath()%>/doctorAvailabilityServlet" method="post">
          <div class="f_row-2">
            <input type="text" class="input-field" placeholder="Enter first name" name="first_name" required>
          </div>
          <div class="f_row-2 last">
            <input type="date" name="date" placeholder="Enter date" class="input-field" required>
          </div>
          <input class="submit-w3" type="submit" value="Load">
